...
# D3 swarm-health instrument attributes
CAO_PROVIDER: Final[str] = "cao.provider"
CAO_AGENT_PROFILE: Final[str] = "cao.agent.profile"
CAO_MODEL: Final[str] = "cao.model"
CAO_ROLE: Final[str] = "cao.role"
CAO_OUTCOME: Final[str] = "cao.outcome"
CAO_SESSION: Final[str] = "cao.session"
CAO_REVIEWER_PROFILE: Final[str] = "cao.reviewer.profile"
CAO_REVIEWER_MODEL: Final[str] = "cao.reviewer.model"
CAO_LENS: Final[str] = "cao.lens"
CAO_COLLISION_KIND: Final[str] = "cao.collision.kind"
